  ...
  return (
    <header className="h-14 border-b border-slate-800 bg-slate-950 flex items-center justify-between px-6 shrink-0">
      <div className="flex items-center gap-3">
        ...
        <span className="font-semibold text-base">MatBrain Agent</span>
        <span className="text-xs text-slate-500 bg-slate-900 px-2 py-0.5 rounded">Solid Electrolyte RAG</span>
      </div>
      <input
        ref={pdfInputRef}
        type="file"
